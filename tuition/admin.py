...
class PostAdmin(admin.ModelAdmin):
    ...
    list_display = ('user','title_html_display','title','created_ad','get_subjects','get_class_in','salary','created_since')
    list_filter = ('user','subject','class_in')
    search_fields = ('details','user__username','subject__name')
    ...
    def created_since(self,Post):
        diff= timezone.now() - Post.created_ad
        return  diff.days
